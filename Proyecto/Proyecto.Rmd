...
```
## Conclusiones 
- Como se puede observar en el boxplot, la proporción de muertes disminuyó de manera significativa después de que se impusiera el lavado de manos en la Clínica 1.
- La proporción de muertes antes del lavado de manos es mucho más alta que después del lavado de manos.
...
t-value (6.7105): Este es el valor de la estadística t. Un valor alto en magnitud (positivo o negativo) sugiere que hay una diferencia significativa entre las medias de los dos grupos.

df (84.198): Grados de libertad. Este valor se utiliza para determinar la significancia del valor t. En una prueba t de Welch, los grados de libertad no siempre son un número entero.

p-value (2.114e-09): El valor p indica la probabilidad de obtener un resultado tan extremo como el observado, asumiendo que la hipótesis nula es verdadera. En este caso, el valor p es extremadamente bajo (mucho menor que 0.05), lo que indica una fuerte evidencia en contra de la hipótesis nula. Por lo tanto, podemos concluir que hay una diferencia significativa entre los dos grupos.

alternative hypothesis: La hipótesis alternativa es que la verdadera diferencia de medias entre el grupo FALSE y el grupo TRUE no es igual a 0.

95 percent confidence interval (0.05290915, 0.09747238): Este intervalo de confianza para la diferencia de medias indica que, con un 95% de confianza, la verdadera diferencia de medias entre los dos grupos está entre 0.0529 y 0.0975. Dado que este intervalo no incluye 0, refuerza la conclusión de que hay una diferencia significativa entre las medias.

mean in group FALSE (0.10691840) y mean in group TRUE (0.03172764): Estas son las medias de proporción de muertes en cada grupo. El grupo FALSE tiene una media de 0.1069, mientras que el grupo TRUE tiene una media de 0.0317.
